...
> 项目链接：https://github.com/Shhh66/rag-intelligent-assistant
...
核心理念：**Agent 不关心工具内部实现，只需一套标准协议即可将任意业务系统接入为可调用的工具**。已接入知识库检索、天气查询、教务课表查询等工具，展示 Agent 自主发现工具、判断意图、编排调用的完整链路。
